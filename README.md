...
المستخدمون يشترون رمزًا من الموقع، يُدخلونه في البوت، فيحصلون على وصول لقنوات تنبيه مخصصة تُعلمهم فور توفر المنتجات. البوت يتحكم بكل شيء: التفعيل، التمديد، الصلاحيات، وعرض الإحصائيات.
